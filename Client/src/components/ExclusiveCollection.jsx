                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-auto lg:h-[600px]">
                    ...
                    >
                        <div className="relative z-10 max-w-sm">
                            <h3 className="text-2xl font-bold text-teal-100 mb-2">stella</h3>
                            <h2 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
                                Your Style,<br />Delivered.<br />Exclusively<br />Online.
                            </h2>
                            <span className="text-teal-100 text-sm">www.stella.com</span>
                        </div>

                        <div className="absolute right-0 bottom-0 h-3/4 w-3/4">
                            <img
                                src="https://images.unsplash.com/photo-1549813069-f95e44d7f498?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                                alt="Delivery"
                                className="w-full h-full object-cover object-top mask-image-b-0"
                    ...
                    <div className="flex flex-col gap-8 h-full">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="relative rounded-3xl overflow-hidden bg-gray-50 p-8 flex-1 flex items-center justify-between group h-full"
                        >
                            ...
                            <div className="w-1/2 flex justify-center">
                                <img
                                    ...
                                    alt="Watch"
                                    className="max-h-40 lg:max-h-56 object-contain drop-shadow-2xl group-hover:scale-110 transition-transform duration-500"
                                />
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="w-1/2 flex justify-center">
                                <img
                                    ...
                                    alt="Sneaker"
                                    className="max-h-40 lg:max-h-56 object-contain drop-shadow-2xl group-hover:rotate-[-12deg] transition-transform duration-500"
                                />
                            </div>
                        </motion.div>
                    </div>
